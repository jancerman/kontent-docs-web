...
(function () {
  ...
  var toggleArticleIntroduction = function toggleArticleIntroduction(section) {
    var directPs = document.querySelectorAll('.article__content > p, .article__content > .callout');
    var hidePs = true;
