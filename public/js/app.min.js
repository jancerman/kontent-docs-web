...
(function () {
  ...
  var formatSuggestion = function formatSuggestion(suggestion, urlMap) {
    ...
    var section = suggestion.section === 'tutorials' && suggestion.resolvedUrl.includes('/reference/') ? 'API' : suggestion.section; // Template for a single search result suggestion
